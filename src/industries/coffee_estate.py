...
industry.add_industry_layout(
    ...
    layout=[
        (0, 0, "coffee_estate_tile_1", "coffee_estate_slope_aware_ground_with_trees_2"),
...
industry.add_industry_layout(
    ...
    layout=[
        (0, 0, "coffee_estate_tile_1", "coffee_estate_slope_aware_ground_with_trees_1"),
...
industry.add_industry_layout(
    ...
    layout=[
        (0, 1, "coffee_estate_tile_1", "coffee_estate_slope_aware_ground_with_trees_1"),
        (0, 2, "coffee_estate_tile_1", "coffee_estate_slope_aware_ground_with_trees_2"),
